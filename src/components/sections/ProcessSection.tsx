...
const STEPS = [
  ...
  },
  {
    ...
    titleEn: 'Development',
    titleAr: 'التطوير',
    descEn: 'Websites, platforms, and systems — custom-coded.',
    descAr: 'نبني المواقع والمنصات والأنظمة ببرمجة مخصصة.',
  },
  {
    num: '05',
    titleEn: 'Launch',
  ...
  },
  {
    ...
    titleEn: 'Support',
    titleAr: 'الدعم',
    descEn: 'We stay after launch — maintenance, updates, growth.',
    descAr: 'نبقى معك بعد الإطلاق — صيانة وتحديثات ونمو.',
  },
]
      ...
      >
        ...
        >
          <div aria-hidden="true" style={{
            ...
            height: '1px', background: 'var(--color-card-border)', zIndex: 0,
          }} />
          <div aria-hidden="true" className={visible ? 'process-line-fill' : ''} style={{
            position: 'absolute', top: '1.25rem',
            left: '1.5rem', height: '1px',
            background: 'var(--color-gold)',
            width: visible ? 'calc(83.33% - 3rem)' : '0',
            transition: 'width 1.2s var(--ease-out)', zIndex: 1,
          }} />

          {STEPS.map((step) => (
            <div key={step.num} style={{
              position: 'relative', zIndex: 2,
              padding: '0 0.75rem', textAlign: 'center',
            }}>
              <div style={{
              ...
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(0.9rem, 1.2vw, 1.1rem)', color: 'var(--color-text)', letterSpacing: '0.05em', marginBottom: '0.5rem' }}>
                {isArabic ? step.titleAr : step.titleEn}
              </p>
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--body-sm)', color: 'var(--color-text-faint)', lineHeight: 1.5 }}>
