...
export const SERVICES: ServicePage[] = [
  // ── CINEMATIC PRODUCTION ─────────────────────────────────────────────────
  {
    ...
    faqEn: [
      { q: 'How long does a commercial take to produce?', a: 'Most projects we produce run from brief to final delivery in four to eight weeks, depending on complexity and the number of versions required.' },
    ...
    faqAr: [
      { q: 'كم يستغرق إنتاج فيلم إعلاني؟', a: 'تستغرق معظم المشاريع من المراجعة الأولى إلى التسليم النهائي بين أربعة وثمانية أسابيع، حسب التعقيد وعدد النسخ المطلوبة.' },
  ...
  },
  {
    ...
    faqEn: [
      ...
      { q: 'What turnaround times apply?', a: 'Animation projects typically run four to twelve weeks from brief to final delivery, depending on length, complexity, and the level of detail required.' },
    ],
    faqAr: [
      ...
      { q: 'ما مدة التسليم للمشاريع المتحركة؟', a: 'تستغرق مشاريع الرسوم المتحركة عادةً بين أربعة واثني عشر أسبوعاً من المراجعة الأولى إلى التسليم النهائي، حسب الطول والتعقيد ومستوى التفاصيل المطلوبة.' },
    ],
  ...
  },
  {
    ...
    faqEn: [
      { q: 'Can you deliver highlight content the same day?', a: 'Yes — same-day highlight reels are one of our standard offerings, delivered within hours of the event ending.' },
    ...
    faqAr: [
      { q: 'هل يمكنكم تسليم أبرز اللقطات في نفس اليوم؟', a: 'نعم — مونتاج أبرز اللقطات في يوم التسليم هو أحد عروضنا الأساسية، يُسلّم خلال ساعات من انتهاء الحدث.' },
  ...
  // ── DIGITAL EXPERIENCES ───────────────────────────────────────────────────
  {
    ...
    howWeWorkEn: [
      ...
      { step: 'Design', desc: 'Design in Figma — responsive, on-brand, and developed with conversion in mind from the first wireframe.' },
    ...
    howWeWorkAr: [
      ...
      { step: 'التصميم', desc: 'تصميم في Figma — متجاوب ومطابق للعلامة ومصمم بتحويل الزوار في الاعتبار من أول Wireframe.' },
    ...
    faqEn: [
      { q: 'How long does a business website take to build?', a: 'Most business websites we build are delivered in six to twelve weeks from brief to launch, depending on scope and the number of pages.' },
    ...
    faqAr: [
      { q: 'كم يستغرق بناء موقع عمل؟', a: 'تُسلّم معظم مواقع الأعمال التي نبنيها في ستة إلى اثني عشر أسبوعاً من المراجعة الأولى إلى الإطلاق، حسب النطاق وعدد الصفحات.' },
  ...
  },
  {
    ...
    faqEn: [
      { q: 'How long does a landing page take to build?', a: 'Standard landing pages are typically delivered within two to four weeks, with more complex or multi-variant pages taking longer depending on requirements.' },
    ...
    faqAr: [
      { q: 'كم يستغرق بناء صفحة هبوط؟', a: 'تُسلّم صفحات الهبوط القياسية عادةً خلال أسبوعين إلى أربعة أسابيع، مع pages أكثر تعقيداً أو متغيرات متعددة تأخذ وقتاً أطول حسب المتطلبات.' },
